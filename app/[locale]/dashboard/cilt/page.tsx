...
const durumBadge = (d: string) => {
  if (d === 'email_gonderildi') return { bg: '#1C3A26', color: '#FAF6EF', text: 'Gonderildi' }
          ...
          <div style={{ background: C.white, borderRadius: 14, border: `1px solid ${C.border}`, padding: 40, textAlign: 'center' }}>
            {arama ? (
              ...
              <div style={{ textAlign: 'center', padding: '60px 20px' }}>
                ...
                <div style={{ fontFamily: cinzel.style.fontFamily, fontSize: 18, color: '#1C3A26', marginBottom: 8 }}>{"Henüz cilt analizi formu gelmedi"}</div>
