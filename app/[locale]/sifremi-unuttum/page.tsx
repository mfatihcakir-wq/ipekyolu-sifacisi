        ...
        {!gonderildi ? (
          <>
            ...
            <input type="email" value={email} onChange={e=>setEmail(e.target.value)} placeholder="ornek@email.com"
              style={{width:'100%',height:48,border:'1px solid #EDD9A3',borderRadius:10,padding:'0 16px',fontSize:16,marginBottom:16,background:'#FDFAF5',outline:'none',boxSizing:'border-box' as const}} />
            <button onClick={handleGonder} disabled={yukleniyor}
              style={{width:'100%',height:48,background:'#1C3A26',border:'none',borderRadius:10,fontFamily:'Cinzel,serif',fontSize:11,fontWeight:700,color:'#F5E9C8',letterSpacing:2,cursor:'pointer'}}>
