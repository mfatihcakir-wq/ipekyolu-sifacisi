...
const BOLUMLER = [
  ...
  { baslik: '4. Veri Paylasimi', icerik: 'Kisisel verileriniz hicbir kosulda reklam amaciyla ucuncu taraflarla paylasilmaz. Verileriniz yalnizca teknik altyapi saglayicilarimizla (Supabase — veritabani, Vercel — hosting, Anthropic — yapay zeka analizi, Shopier — odeme) zorunlu olarak paylasilmaktadir.' },
  ...
  { baslik: '6. Veri Guvenligi', icerik: 'Tum veriler Supabase uzerinde Row Level Security (RLS) ile korunmaktadir. Odeme islemleri Shopier altyapisi ile guvenli sekilde gerceklestirilmektedir. Kart bilgileri sunucularimizda saklanmamaktadir.' },
