    ...
    <div style={{ background: C.cream, minHeight: '100vh', fontFamily: garamond.style.fontFamily }}>
      ...
      <div style={{ maxWidth: 800, margin: '0 auto', padding: '48px 24px' }}>
        ...
        <div style={{ marginBottom: 40 }}>
          ...
          <p style={{ fontSize: 15, color: C.secondary, lineHeight: 1.8 }}>
            {"Analizlerimiz 98 klasik İslam ve Osmanlı tıbbı eserinden derlenen dijitalleştirilmiş bilgi tabanına dayanır. Sistemimiz bu kaynaklardan ilgili bölümleri bulur ve eşleştirir; ancak nihai karar her zaman danışman tarafından verilir. Kaynak gösterilemeyen hiçbir öneri sunulmaz."}
          </p>
        </div>

        {/* 18 KLASİK ESER */}
        <div style={{ marginBottom: 40 }}>
          <h2 style={{ fontFamily: cinzel.style.fontFamily, fontSize: 18, color: C.gold, marginBottom: 16, letterSpacing: 2 }}>{"BAŞLICA KAYNAKLARIMIZ"}</h2>
          <p style={{ fontSize: 13, color: C.secondary, fontStyle: 'italic', marginBottom: 16, lineHeight: 1.6 }}>{"Veritabanımız 98 klasik İslam ve Osmanlı tıbbı kaynağından oluşuyor. Aşağıda en yoğun atıf yapılan eserler listelenmiştir."}</p>
        ...
        <div style={{ marginBottom: 40 }}>
          ...
          <div style={{ background: C.white, borderRadius: 14, border: `1px solid ${C.border}`, padding: '28px 32px' }}>
            ...
            <div style={{ fontSize: 14, color: C.secondary, lineHeight: 1.8 }}>
              <p style={{ marginBottom: 12 }}>{"Kocaeli Üniversitesi Tıp Tarihi yüksek lisansı. FSM Vakıf Üniversitesi Fuat Sezgin İslam Bilim Tarihi Enstitüsü doktora programı öğrencisi."}</p>
