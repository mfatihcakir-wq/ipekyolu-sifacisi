...
const C = { primary: '#1B4332', gold: '#8B6914', cream: '#F5EFE6', secondary: '#5C4A2A', border: '#E0D5C5', white: '#FFFFFF', surface: '#FAF7F2' }

const KAYNAKLAR: { ad: string; ozel?: string }[] = [
  { ad: 'el-Havi fit-Tib — er-Razi (Cilt 1-5, 8.348 kayit)' },
  { ad: 'Tahbizul-Mathun — Tokadi Mustafa Efendi (6.076 kayit)' },
  { ad: 'el-Samil fis-Sinaatit-Tibbiyye — Ibn Nefis (Cilt 1, 1.368 kayit)' },
  { ad: 'Takasimul-Ilel — er-Razi (1.000 kayit)' },
  { ad: 'et-Tasrif — ez-Zehravi (998 kayit)' },
  { ad: 'el-Cami li-Mufredatil-Edviye — Ibn Baytar (798 kayit)' },
  { ad: 'el-Kulliyyat fit-Tib — Ibn Rusd (637 kayit)' },
  { ad: 'el-Mucez fit-Tib — Ibn Nefis (492 kayit)' },
  { ad: 'et-Teysir — Ibn Zuhr (415 kayit)' },
  ...
  { ad: 'el-Agziye — Ibn Zuhr (91 kayit)' },
  { ad: 'el-Kanun fit-Tib — Ibn Sina (Cilt 1-5)' },
  { ad: 'el-Havi fit-Tib — er-Razi (Cilt 6-10)' },
  { ad: 'el-Havi fit-Tib — er-Razi (Cilt 11-15)' },
  { ad: 'el-Havi fit-Tib — er-Razi (Cilt 16-20)' },
  { ad: 'el-Mansuri fit-Tib — er-Razi' },
  { ad: 'el-Medhal ila Sinaatit-Tib — er-Razi' },
  { ad: 'Takasimul-Ilel — er-Razi (ek ciltler)' },
  { ad: 'el-Samil fis-Sinaatit-Tibbiyye — Ibn Nefis (Cilt 2-5)' },
  { ad: 'el-Samil fis-Sinaatit-Tibbiyye — Ibn Nefis (Cilt 6-10)' },
  { ad: 'el-Samil fis-Sinaatit-Tibbiyye — Ibn Nefis (Cilt 11-15)' },
  { ad: 'el-Samil fis-Sinaatit-Tibbiyye — Ibn Nefis (Cilt 16-20)' },
  { ad: 'Serhu Fusuli Buqrat — Ibn Nefis' },
  { ad: 'el-Muhtar fit-Tib — Ibn Nefis' },
  { ad: 'el-Mucez fit-Tib — Ibn Nefis (ek ciltler)' },
