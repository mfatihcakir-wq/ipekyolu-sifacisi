...
const SORULAR = [
  ...
  { s: 'Hangi klasik kaynaklardan yararlanıyorsunuz?', c: '38 klasik İslam ve Osmanlı tıbbı eserinden yararlanıyoruz. Başlıcaları: el-Havi fit-Tib (er-Râzî), el-Samil (İbn Nefis), Tahbizul-Mathun (Tokadi Mustafa Efendi) ve el-Kânûn fit-Tib (İbn Sina). Tamamı dijitalleştirilmiş ve yapılandırılmış formatta analiz motoruna entegre edilmiştir.' },
  ...
  { s: 'Ödeme güvenli mi?', c: 'Tüm ödemeler Shopier altyapısı ile güvenli şekilde gerçekleştirilir. Kart bilgileriniz sunucularımızda saklanmaz.' },
