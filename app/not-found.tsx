...
export default function NotFound() {
  return (
    <div style={{ minHeight: '100vh', background: '#F5EFE6', display: 'flex', flexDirection: 'column' as const, fontFamily: 'Georgia, serif' }}>
      <div style={{ background: '#1B4332', padding: '16px 24px', textAlign: 'center' }}>
        <div style={{ color: '#C9A84C', fontSize: 14, fontWeight: 600, letterSpacing: 3 }}>{"İPEK YOLU ŞİFACISI"}</div>
      </div>
