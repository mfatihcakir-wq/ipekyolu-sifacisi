...
export default function NotFound() {
  return (
    <div style={{ minHeight: '100vh', background: '#FAF6EF', display: 'flex', flexDirection: 'column' as const, fontFamily: 'Georgia, serif' }}>
      <div style={{ background: '#1C3A26', padding: '16px 24px', textAlign: 'center' }}>
        <div style={{ color: '#B8860B', fontSize: 14, fontWeight: 600, letterSpacing: 3 }}>{"İPEK YOLU ŞİFACISI"}</div>
      </div>
      <div style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
        <div style={{ textAlign: 'center', padding: '40px 20px' }}>
          <div style={{ fontSize: 80, marginBottom: 8, opacity: 0.3 }}>{"⚗️"}</div>
          <h1 style={{ fontSize: 48, color: '#1C3A26', marginBottom: 4, fontWeight: 300 }}>404</h1>
          <h2 style={{ fontSize: 22, color: '#1C3A26', marginBottom: 8, fontWeight: 500 }}>{"Sayfa Bulunamadı"}</h2>
